...
export default function Slug({ saveCart, clearCart, addToCart, removeToCart, subTotal }) {
        ...
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex">
              ...
              <button
                onClick={() =>
                  addToCart(slug, 1, 499, "wear the code1", "xl", "red")
                }
                class="flex ml-10 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded"
              >
                addToCart
              </button>
            ...
            {!service && service != null && (
              <div className=" text-red-500">
                sorry ! we do not delivar to this pincode
              </div>
            )}
            {service && service != null && (
              <div className=" text-green-500">
                yahh this pincode is serviceable
              </div>
            )}
          </div>
        </div>
